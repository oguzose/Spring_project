...
public class InstructorController {
	...
	public String postInstructorCreate(
			@ModelAttribute @Valid Instructor instructor,
	...
	public String getAdminUpdate(@PathVariable("id") Long id, Model model,
		...
		model.addAttribute("instructor",
				this.instructorService.getInstructorWithCourses(id)); // bunun
																		// geri
																		// dönüşü
																		// "instructor"
																		// objesi
	...
	public String postInstructornUpdate(@PathVariable("id") Long id,
			@ModelAttribute Instructor instructor, Model model) {
