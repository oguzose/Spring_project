...
public class WebConfig extends WebMvcConfigurerAdapter {
	...
	public HibernateTransactionManager getTransactionManager(
		...
		return transactionManager; // database transactinları yönetiyor. Rol
									// backleri vb.
	}

	@Autowired
	@Bean(name = "sessionFactory")
	// hibarnate özel. Spring görürse
	public SessionFactory getSessionFactory(DataSource dataSource) {

		LocalSessionFactoryBuilder sessionBuilder = new LocalSessionFactoryBuilder(
				dataSource);

		sessionBuilder.scanPackages("tr.org.lkd.lyk2015.camp"); // entitylere
																// bakıyor
	...
	private Properties getHibernateProperties() {
		...
		/**
		 * yukarda hibarnate otomatik sql cümleleri ürettiginde kullandığımız
		 * sqlite yada postgresql kullandığımızı belirtiyoruz
		 */
